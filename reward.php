...
<div class="container">
  <div class=" text-center bg-white">
    <h1 class="display-4 text-warning">HAIL Rewards</h1>
  ...
  <div class="container text-center">
      <h1 class="display-4 text-warning">Ranking</h1>
  ...
  <div class="text-center mt-5">
    <h1 class="display-4 mb-5 text-warning">Rewards for The Season</h1>
